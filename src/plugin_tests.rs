...
//! exit-code-to-abort, and the recursion guard — is exercised end to end. The
//! `protocol` self-describe and the bounded stderr relay live in the sibling
//! `describe_tests` module.
...
fn ctx() -> OpContext {
    OpContext {
        ...
        command: Some(Command { op: "close".into(), id: Some("bl-1234".into()), body_change: None, message: None, target: None }),
        before: None,
    }
}
