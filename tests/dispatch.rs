...
/// Run `git -C <cwd> <args>`, asserting success — the harness builds bare repos
/// with plain git (no access to the crate-internal runner). (The center-adoption
/// end-to-end tests live in `tests/enrollment.rs`.)
